...
import { Box, CartesianMarkerProps, Dimensions, Margin, MotionProps, PropertyAccessor, SvgDefsAndFill, ValueFormat, WithChartRef, ResponsiveProps } from '@nivo/core';
...
export type BarsWithHidden<D extends BarDatum> = Array<Partial<{
    key: string;
    x: number;
    y: number;
    width: number;
...
interface BarCustomLayerBaseProps<D extends BarDatum> extends Pick<BarCommonProps<D>, 'borderRadius' | 'borderWidth' | 'enableLabel' | 'isInteractive' | 'labelSkipHeight' | 'labelSkipWidth' | 'tooltip'>, Dimensions {
...
export interface BarCustomLayerProps<D extends BarDatum> extends BarCustomLayerBaseProps<D>, BarHandlers<D, SVGRectElement> {
}
export interface BarCanvasCustomLayerProps<D extends BarDatum> extends BarCustomLayerBaseProps<D>, BarHandlers<D, HTMLCanvasElement> {
}
export type BarCanvasCustomLayer<D extends BarDatum> = (context: CanvasRenderingContext2D, props: BarCanvasCustomLayerProps<D>) => void;
...
export interface BarItemProps<D extends BarDatum> extends Pick<BarCommonProps<D>, 'borderRadius' | 'borderWidth' | 'isInteractive' | 'tooltip'>, BarHandlers<D, SVGRectElement> {
...
export type RenderBarProps<D extends BarDatum> = Omit<BarItemProps<D>, 'isInteractive' | 'style' | 'tooltip' | 'isFocusable' | 'ariaLabel' | 'ariaLabelledBy' | 'ariaDescribedBy' | 'ariaHidden' | 'ariaDisabled'> & BarLabelLayout & {
    borderColor: string;
    labelStyle: TextStyle;
};
export type BarCanvasRenderer<D extends BarDatum> = (context: CanvasRenderingContext2D, props: RenderBarProps<D>) => void;
...
export type BarSvgProps<D extends BarDatum> = DataProps<D> & Partial<BarCommonProps<D>> & Partial<BarSvgExtraProps<D>> & BarHandlers<D, SVGRectElement> & SvgDefsAndFill<ComputedBarDatum<D>> & Dimensions & MotionProps;
export type ResponsiveBarSvgProps<D extends BarDatum> = WithChartRef<ResponsiveProps<BarSvgProps<D>>, SVGSVGElement>;
export type BarSvgPropsWithDefaults<D extends BarDatum> = DataProps<D> & BarCommonProps<D> & BarSvgExtraProps<D> & SvgDefsAndFill<ComputedBarDatum<D>> & Dimensions & MotionProps;
...
export type BarCanvasProps<D extends BarDatum> = DataProps<D> & Partial<BarCommonProps<D>> & Partial<BarCanvasExtraProps<D>> & BarHandlers<D, HTMLCanvasElement> & Dimensions;
export type ResponsiveBarCanvasProps<D extends BarDatum> = WithChartRef<ResponsiveProps<BarCanvasProps<D>>, HTMLCanvasElement>;
export type BarCanvasPropsWithDefaults<D extends BarDatum> = DataProps<D> & BarCommonProps<D> & BarCanvasExtraProps<D> & BarHandlers<D, HTMLCanvasElement> & Dimensions;
