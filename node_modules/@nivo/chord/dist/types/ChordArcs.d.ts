...
export declare const ChordArcs: import("react").MemoExoticComponent<({ arcs, borderWidth, borderColor, getOpacity, arcGenerator, setCurrent, isInteractive, onMouseEnter, onMouseMove, onMouseLeave, onClick, tooltip, }: ChordArcsProps) => import("react/jsx-runtime").JSX.Element>;
export {};
