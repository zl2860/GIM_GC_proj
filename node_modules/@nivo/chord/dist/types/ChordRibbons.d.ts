...
export declare const ChordRibbons: import("react").MemoExoticComponent<({ ribbons, ribbonGenerator, borderWidth, borderColor, getOpacity, blendMode, isInteractive, setCurrent, onMouseEnter, onMouseMove, onMouseLeave, onClick, tooltip, }: ChordRibbonsProps) => import("react/jsx-runtime").JSX.Element>;
export {};
