...
export declare const ChordRibbon: import("react").MemoExoticComponent<({ ribbon, ribbonGenerator, animatedProps, borderWidth, blendMode, isInteractive, setCurrent, onMouseEnter, onMouseMove, onMouseLeave, onClick, tooltip, }: ChordRibbonProps) => import("react/jsx-runtime").JSX.Element>;
export {};
