...
export declare const SankeyNodeTooltip: <N extends DefaultNode, L extends DefaultLink>({ node, }: SankeyNodeTooltipProps<N, L>) => import("react/jsx-runtime").JSX.Element;
