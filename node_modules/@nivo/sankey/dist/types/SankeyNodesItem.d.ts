...
export declare const SankeyNodesItem: <N extends DefaultNode, L extends DefaultLink>({ node, x, y, width, height, color, opacity, borderWidth, borderColor, borderRadius, setCurrent, isInteractive, onClick, tooltip, }: SankeyNodesItemProps<N, L>) => import("react/jsx-runtime").JSX.Element;
export {};
