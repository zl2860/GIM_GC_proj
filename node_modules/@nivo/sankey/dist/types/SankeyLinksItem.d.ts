...
export declare const SankeyLinksItem: <N extends DefaultNode, L extends DefaultLink>({ link, layout, path, color, opacity, blendMode, enableGradient, setCurrent, tooltip, isInteractive, onClick, }: SankeyLinksItemProps<N, L>) => import("react/jsx-runtime").JSX.Element;
export {};
