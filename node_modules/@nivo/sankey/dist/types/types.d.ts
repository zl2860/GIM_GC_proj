...
import { Box, CssMixBlendMode, Dimensions, MotionProps, PropertyAccessor, ValueFormat } from '@nivo/core';
...
export type SankeyLabelComponent<N extends DefaultNode, L extends DefaultLink> = FunctionComponent<TextProps & {
