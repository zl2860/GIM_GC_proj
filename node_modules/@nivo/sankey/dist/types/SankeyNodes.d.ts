...
export declare const SankeyNodes: <N extends DefaultNode, L extends DefaultLink>({ nodes, nodeOpacity, nodeHoverOpacity, nodeHoverOthersOpacity, borderWidth, getBorderColor, borderRadius, setCurrentNode, currentNode, currentLink, isCurrentNode, isInteractive, onClick, tooltip, }: SankeyNodesProps<N, L>) => import("react/jsx-runtime").JSX.Element;
export {};
