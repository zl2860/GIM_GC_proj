...
export declare const SankeyLinks: <N extends DefaultNode, L extends DefaultLink>({ links, layout, linkOpacity, linkHoverOpacity, linkHoverOthersOpacity, linkContract, linkBlendMode, enableLinkGradient, setCurrentLink, currentLink, currentNode, isCurrentLink, isInteractive, onClick, tooltip, }: SankeyLinksProps<N, L>) => import("react/jsx-runtime").JSX.Element;
export {};
