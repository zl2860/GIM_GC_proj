...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigationItems = [
    ...
    { path: '/correlations', icon: Table, label: 'LC-MS Correlations', color: 'text-pink-400' },
    { path: '/risk-associations', icon: BarChart3, label: 'Risk Estimates', color: 'text-red-400' },
